...
class Add_Employee implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String h = t8.getText();    //education
        String i = t9.getText();    //job
        String j = t10.getText();   //adhar
        String k = t11.getText();   //id
        if(ae.getSource() == b) //(b = submit)
        {
            try
            {
                conn cc = new conn();
                ...
                JOptionPane.showMessageDialog(null,"Details Successfully Inserted");  // popup throw
                f.setVisible(false);
                new details();
            }
            catch(Exception ee)
        ...
        else if(ae.getSource() == b1)  // b1 = cancel
        {
            f.setVisible(false);
            new details();
        }
